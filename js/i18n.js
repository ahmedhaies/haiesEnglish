...
export const STRINGS = {
  ar: {
    ...
    learned: 'كلمات تعلمتها', mastered: 'أتقنتها', total_words: 'إجمالي الكلمات', remaining: 'المتبقي', progress: 'التقدّم', studied: 'ذاكرتها',
    ...
    watch_videos: 'شاهد الكلمة في فيديو', see_images: 'صور حقيقية', open_youglish: 'افتح المشغّل في يوجليش',
  ...
  en: {
    ...
    learned: 'Words learned', mastered: 'Mastered', total_words: 'Total words', remaining: 'Remaining', progress: 'Progress', studied: 'studied',
    ...
    watch_videos: 'Watch the word in videos', see_images: 'Real images', open_youglish: 'Open the player on YouGlish',
